                ...
                <div class="card-body">
                    <form method="POST" action="#">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nome" type="text" class="form-control @error('name') is-invalid @enderror" name="nome" value="{{ old('nome') }}" required autocomplete="nome" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="raca" type="text" class="form-control @error('raca') is-invalid @enderror" name="raca" value="{{ old('raca') }}" autocomplete="raca">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="idade" type="number" class="form-control @error('idade') is-invalid @enderror" name="idade" value="{{ old('idade') }}" autocomplete="idade">
